...
public class ExcelUtility {
	static FileInputStream f;// Inbuilt class used to input a file(get a class)
	static XSSFWorkbook w;// used to input a workbook from file(inbuilt class)
	static XSSFSheet s;// used to input excel sheet
